...
const config: HardhatUserConfig = {
  ...
  networks: {
    ...
    goerli: {
      accounts,
      chainId: 5,
      url: process.env.GOERLI_RPC_URL || "https://goerli.infura.io/v3/7672e2bf7cbe427e8cd25b0f1dde65cf",
    },
    "optimism-goerli": {
      accounts,
      chainId: 420,
      url:
        process.env.OPTIMISM_GOERLI_RPC_URL || "https://optimism-goerli.infura.io/v3/7672e2bf7cbe427e8cd25b0f1dde65cf",
    },
    mumbai: {
      accounts,
      chainId: 80001,
      url: process.env.MUMBAI_RPC_URL || "https://polygon-mumbai.infura.io/v3/7672e2bf7cbe427e8cd25b0f1dde65cf",
    },
    "arbitrum-goerli": {
      accounts,
      chainId: 421613,
      url:
        process.env.ARBITRUM_GOERLI_RPC_URL || "https://arbitrum-goerli.infura.io/v3/7672e2bf7cbe427e8cd25b0f1dde65cf",
    },
    "gnosis-testnet": {
      accounts,
      chainId: 10200,
